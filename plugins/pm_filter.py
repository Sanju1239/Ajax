...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/Telugu_Movies_2000'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/Telugu_Movies_2000')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('CONTACT ME', url='https://t.me/TysonSanju4555'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ SUBSCᏒIBΞ  ✅', url='https://youtube.com/channel/UCMql4BXVZnjJyBFBTKFHDeg')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)      
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('♥️ SԾUᏒCΞ ♥️', url='https://t.me/Telugu_Movies_2000')
            ],[
            InlineKeyboardButton('🏠 𝗛𝗼𝗺𝗲 🏠', callback_data='start'),
